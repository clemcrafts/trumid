...
def step_generate_medium_test_data(context):
    generate_test_data(context, cities=["New York", "Los Angeles", "Detroit", "Chicago", "San Francisco", "Seattle"], frequency='1T')


@given('we have generated a large dataset')
def step_generate_large_test_data(context):
    generate_test_data(context, cities=["New York", "Los Angeles", "Detroit", "Chicago", "San Francisco", "Seattle", "London", "Paris"], frequency='1T')
